# Algoritimo que ensina a fazer um bolo de chocolate
# Feito por igor no dia 17/05/2022 ás 19:03
...
print("""
    ...
    Bolo
Misture os ovos com açúcar e o chocolate em pó ou achocolatado.
